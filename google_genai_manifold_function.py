"""
title: Gemini Manifold Function
authors: justinh-rahb and bgeneto (improvements)
author_url: https://github.com/justinh-rahb
funding_url: https://github.com/open-webui
version: 0.1.7
license: MIT
requirements: google.generativeai, pydantic
environment_variables: GOOGLE_API_KEY, USE_PERMISSIVE_SAFETY
"""
...
class Pipe:
    class Valves(BaseModel):
        ...
        USE_PERMISSIVE_SAFETY: bool = Field(
            default=True, description="Use permissive safety settings"
        )
    ...
    def get_google_models(self, whitelist: str = "") -> List[dict]:
        ...
        try:
            ...
            return [
                ...
                if not whitelist or model.name[7:].lower() in whitelist
            ]
    ...
    def pipes(self) -> List[dict]:
        return self.get_google_models(self.valves.MODELS_WHITELIST)
